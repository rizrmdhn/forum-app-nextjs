...
function createCommentThreadDetailActionCreator(
  threadId: string,
  comment: IThreadComment,
): CreateCommentThreadDetailAction {
  return {
...
function upVoteCommentThreadDetailActionCreator(
  threadId: string,
  commentId: string,
  userId: string,
): UpVoteCommentThreadDetailAction {
...
function downVoteCommentThreadDetailActionCreator(
  threadId: string,
  commentId: string,
  userId: string,
): DownVoteCommentThreadDetailAction {
...
function neutralVoteCommentThreadDetailActionCreator(
  threadId: string,
  commentId: string,
  userId: string,
): NeutralVoteCommentThreadDetailAction {
